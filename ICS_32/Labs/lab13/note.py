...
class Note:
    def __init__(self, note_path: Path):
        ...
        if not note_path.exists():
            raise FileNotFoundError(
                        "The Note file specified in note_path does not exist.")
    ...
    def save_note(self, note: str):
        """
        adds the value passed to the note parameter
        to the all_notes list. Saves to file
        """
    ...
    def remove_note(self, noteid: int) -> str:
        ...
        :param noteid: the 0-based index of the note stored in the list
        returned by read_notes method
