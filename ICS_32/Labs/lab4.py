...
You are free to play with the numbers if you want. Lower numbers will simplify the
results,
...
def tree_builder(nodes:list, level:int, acorn:str) -> list:
    """
    Builds a tree using the random integers selected from the tree_depth and
    node_depth defaults
    """
